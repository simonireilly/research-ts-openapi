 ...
 * @export
 */
export const PetsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @param {NewPet} [newPet] Create pet body
    ...
    showPetById: async (
      ...
      const localVarPath = `/pets/{petId}`.replace(
        `{${'petId'}}`,
...
export const PetsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createPets(
        newPet,
        options
      );
    ...
    async listPets(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Pet>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listPets(
        limit,
        options
      );
      return createRequestFunction(
    ...
    async showPetById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Pet>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.showPetById(
        petId,
        options
      );
      return createRequestFunction(
...
export const PetsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createPets(newPet?: NewPet, options?: any): AxiosPromise<void> {
      return localVarFp
        .createPets(newPet, options)
...
export class PetsApi extends BaseAPI {
   ...
   * @memberof PetsApi
   */
  public createPets(newPet?: NewPet, options?: AxiosRequestConfig) {
